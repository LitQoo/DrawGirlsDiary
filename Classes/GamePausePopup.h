...
{
public:
	static GamePausePopup* create(int t_touch_priority, function<void()> t_end_func, function<void()> t_restart_func);
...
private:
	...
	void myInit(int t_touch_priority, function<void()> t_end_func, function<void()> t_restart_func);
};
