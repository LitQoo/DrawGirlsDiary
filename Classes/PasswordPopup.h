...
#ifndef __DgDiary__PasswordPopup__
#define __DgDiary__PasswordPopup__
...
class KSLabelTTF;
class PasswordPopup : public CCLayer, public CCEditBoxDelegate
{
public:
	static PasswordPopup* create(int t_touch_priority, function<void()> t_end_func);
...
#endif /* defined(__DgDiary__PasswordPopup__) */
